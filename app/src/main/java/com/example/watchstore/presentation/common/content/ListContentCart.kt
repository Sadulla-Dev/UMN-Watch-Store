...
import com.example.watchstore.theme.DIMENS_64dp
...
fun ListContentCart(
    ...
    onClickSelected: (ProductItem) -> Unit
...
fun ContentCart(
    ...
    Column {
        ...
        Row(
            modifier = modifier
                .clickable { onClickSelected(productItem) }
                .fillMaxWidth()
...
fun ListContentCartPreview() {
    ListContentCart(cartProducts = emptyList(), onClickDeleteCart = {}, onClickSelected = {})
}